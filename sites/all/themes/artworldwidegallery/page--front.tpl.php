            ...
            <div class="row">
              <div class="main-header-inner">
                ...
                <div class="nav-top">
                  <div class="nav-logo">
                    <?php if ($logo): ?>
                      <a href="<?php print $front_page; ?>" title="<?php print t('MyShop'); ?>" rel="" id="logo">
                        <img src="<?php print $logo; ?>" alt="<?php print t('MyShop'); ?>" />
                      </a>
                    <?php endif; ?>
                  </div>
                ...
                <div class="mobile-navigation">
                  ...
                  <div class="nav-logo visible-xs">
                    <div>
                      <?php if ($logo): ?>
                        <a href="<?php print $front_page; ?>" title="<?php print t('MyShop'); ?>" rel="MyShop" id="logo">
                          <img src="<?php print $logo; ?>" alt="<?php print t('MyShop'); ?>" />
                        </a>
                      <?php endif; ?>
                    </div>
  ...
  <main class="main-content" id="MainContent" role="main">
    <section class="home_slideshow main-slideshow">
      <div class="container banner-slider">
        ...
        <div class="banner_item banner-1 hidden-xs">
